...
if (!empty($_SESSION['user']) and !empty($_SESSION['pass'])) {
  $_SESSION['code_viewer'] = $_GET['code'];
  ?>
  <!DOCTYPE html>
  <!--
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      'use strict';
      var DEFAULT_URL = '../view.php?id=<?php echo $_GET['code'];?>';
...
//#endif
  ...
  <body oncontextmenu="return false;" oncopy="return false" oncut="return false" onpaste="return false" tabindex="1">
    ...
    <div id="mainContainer">
      ...
      <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
        <div id="secondaryToolbarButtonContainer">
          ...
          <button id="secondaryDownload" hidden="hidden" disabled="disabled" class="secondaryToolbarButton download visibleMediumView" title="Download"
          ...
          <button id="firstPage" class="secondaryToolbarButton firstPage" title="Go to First Page" tabindex="23"
          ...
          <button id="pageRotateCw" class="secondaryToolbarButton rotateCw" title="Rotate Clockwise" tabindex="25"
          ...
          <button id="toggleHandTool" class="secondaryToolbarButton handTool" title="Enable hand tool" tabindex="27"
          ...
          <button id="documentProperties" class="secondaryToolbarButton documentProperties" title="Document Properties…"
                  tabindex="28" data-l10n-id="document_properties">
        ...
        <div id="toolbarContainer">
          <div id="toolbarViewer">
            ...
            <div id="toolbarViewerRight">
              ...
              <button hidden="hidden" disabled="disabled" id="openFile" class="toolbarButton openFile hiddenLargeView"
                      title="Open File" tabindex="13" data-l10n-id="open_file">
                <span data-l10n-id="open_file_label">Open</span>
              </button>

              <button hidden="hidden" disabled="disabled" id="print" class="toolbarButton print hiddenMediumView"
                      title="Print" tabindex="14" data-l10n-id="print">
                <span data-l10n-id="print_label">Print</span>
              </button>

              <button hidden="hidden" disabled="disabled" id="download" class="toolbarButton download hiddenMediumView"
  ...
  echo '<script language="javascript">alert("ERROR!!! Unauthenticated session detected!.");document.location="http://'.$_SERVER['HTTP_HOST'].'"</script>';
}
  ?>